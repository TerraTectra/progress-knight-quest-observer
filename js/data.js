var gameData = {
    ...
    observer: {
        ...
        upgrades: {
            ...
            gentle_push: 0,
            mistake_recovery: 0,
            streak_preservation: 0,
            better_instincts: 0,
            quiet_patronage: 0,
            hidden_patronage: 0,
            character_refinement: 0,
            deep_simulation: 0,
            threshold_tutoring: 0,
            threshold_intuition: 0,
        },
    },
    perks_points: 0,
    perks: {
...
const permanentUnlocks = ["Quick task display", "Evil perks", "Rebirth tab", "Dark Matter", "Dark Matter Skills", "Dark Matter Skills2", "Multiverse", "Metaverse", "Metaverse Perks", "Metaverse Perks Button", "Congratulations"]
...
const requirementsBaseData = {
    ...
    "Universe V Commerce": new MultiverseUniverseRequirement([removeSpaces(".Universe V Commerce")], [{ universe: 5 }]),
    ...
    // Metaverse Altars
    "Multiverse": new MultiverseRequirement(["#multiverseTabButton", "#multiversePointsInfo"], [{ requirement: 1 }]),
